...
class UrlSearchScreen extends StatefulWidget {
  @override
  _UrlSearchScreenState createState() => _UrlSearchScreenState();
}
...
class _UrlSearchScreenState extends State<UrlSearchScreen> {
  ...
  void _handleButtonPressed() async {
    ...
    if (_formKey.currentState.validate()) {
      ...
      bool isValid;
      try {
        isValid = await NewsService.validateUrl(_controllerSearch.text);
        if (isValid)
          setState(() {
        ...
        Alerts.showSnackBar(_scaffoldKey, err.message, color: Colors.red);
        setState(() {
          _icon = Icons.cancel;
        });
      }
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: OutlinedTextField(
                      ...
                      autocorrect: true,
                      validator: Validators.requireUrl,
                      hintText: 'Search url...',
